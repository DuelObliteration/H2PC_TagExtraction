...
namespace BlamLib.Blam.Halo2.Tags
{
	...
	partial class character_group
	{
		...
		partial class character_movement_block
		{
			...
			{
				Add(MovementFlags = new TI.Flags());
				Add(PathfindingRadius = new TI.Real());
				Add(DestinationRadius = new TI.Real());
				Add(new TI.UselessPad(20));
				Add(DiveGrenadeChance = new TI.Real());
				Add(new TI.UselessPad(8));
				Add(ObstacleLeapMinSize = new TI.Enum());
				Add(ObstacleLeapMaxSize = new TI.Enum());
				Add(ObstacleIgnoreSize = new TI.Enum());
				Add(ObstacleSmashableSize = new TI.Enum());
				Add(new TI.Pad(2));
				Add(JumpHeight = new TI.Enum());
				Add(MovementHints = new TI.Flags());
				Add(ThrottleScale = new TI.Real());
			}
			#endregion
		};
		#endregion
		...
		public character_group() : base(38)
		{
			...
			Add(ChargeProperties = new TI.Block<character_charge_block>(this, 3));
			Add(EvasionProperties = new TI.Block<character_evasion_block>(this, 3));
			Add(CoverProperties = new TI.Block<character_cover_block>(this, 3));
			Add(RetreatProperties = new TI.Block<character_retreat_block>(this, 3));
			Add(SearchProperties = new TI.Block<character_search_block>(this, 3));
			Add(Pre-searchProperties = new TI.Block<character_presearch_block>(this, 3));
			Add(IdleProperties = new TI.Block<character_idle_block>(this, 3));
			Add(VocalizationProperties = new TI.Block<character_vocalization_block>(this, 1));
			Add(BoardingProperties = new TI.Block<character_boarding_block>(this, 1));
			Add(new TI.UselessPad(12));
			Add(BossProperties = new TI.Block<character_boss_block>(this, 1));
			Add(WeaponsProperties = new TI.Block<character_weapons_block>(this, 100));
			Add(FiringPatternProperties = new TI.Block<character_firing_pattern_properties_block>(this, 100));
			Add(new TI.UselessPad(24));
			Add(GrenadesProperties = new TI.Block<character_grenades_block>(this, 10));
			Add(new TI.UselessPad(24));
			Add(VehicleProperties = new TI.Block<character_vehicle_block>(this, 100));
		}
		#endregion
	};
	#endregion
