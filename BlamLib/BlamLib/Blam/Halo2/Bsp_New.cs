...
namespace BlamLib.Blam.Halo2.Tags
{
	...
	public class pathfinding_data_block : TI.Definition
	{
		...
		public class pathfinding_hints_block : TI.Definition
		{
			...
			{
				Add(HintType = new TI.Enum());
				Add(NextHintIndex = new TI.ShortInteger());
				Add(HintData0 = new TI.ShortInteger());
				Add(HintData1 = new TI.ShortInteger());
				Add(HintData2 = new TI.ShortInteger());
				Add(HintData3 = new TI.ShortInteger());
				Add(HintData4 = new TI.ShortInteger());
				Add(HintData5 = new TI.ShortInteger());
				Add(HintData6 = new TI.ShortInteger());
				Add(HintData7 = new TI.ShortInteger());
			}
			#endregion
		}
		#endregion
		...
		public class instanced_geometry_reference_block : TI.Definition
		{
			...
			{
				Add(PathfindingObject_index = new TI.ShortInteger());
				Add(new TI.Pad(2));
			}
			#endregion
		}
		...
		public class user_hint_block : TI.Definition
		{
			...
			public class user_hint_point_block : TI.Definition
			{
				...
				{
					Add(Point = new TI.RealPoint3D());
					Add(ReferenceFrame = new TI.ShortInteger());
					Add(new TI.Pad(2));
				}
				#endregion
			}
	...
	public partial class scenario_structure_bsp_group : TI.Definition, ITagImportInfo
	{
		...
		public partial class structure_bsp_instanced_geometry_instances_block : TI.Definition
		{
				...
				: base(13)
			{
				...
				Add(PathfindingPolicy = new TI.Enum());
				Add(LightmappingPolicy = new TI.Enum());
			}
			#endregion
		};
		#endregion
		...
		public scenario_structure_bsp_group() : base(55)
		{
			...
			Add(UNUSEDnodes = new TI.Block<UNUSED_structure_bsp_node_block>(this, 131072));
			...
			Add(SurfaceReferences = new TI.Block<structure_bsp_surface_reference_block>(this, 262144));
			...
			Add(SkyOwnerCluster = new TI.Block<structure_bsp_sky_owner_cluster_block>(this, 32));
			Add(ConveyorSurfaces = new TI.Block<structure_bsp_conveyor_surface_block>(this, 512));
			Add(BreakableSurfaces = new TI.Block<structure_bsp_breakable_surface_block>(this, 8448));
			Add(PathfindingData = new TI.Block<pathfinding_data_block>(this, 16));
			Add(PathfindingEdges = new TI.Block<structure_bsp_pathfinding_edges_block>(this, 262144));
			...
			Add(EnvironmentObjectPalette = new TI.Block<structure_bsp_environment_object_palette_block>(this, 100));
			Add(EnvironmentObjects = new TI.Block<structure_bsp_environment_object_block>(this, 16384));
			...
			Add(LeafMapConnections = new TI.Block<global_leaf_connection_block>(this, 524288));
			Add(Errors = new TI.Block<global_error_report_categories_block>(this, 64));
			Add(PrecomputedLighting = new TI.Block<structure_bsp_precomputed_lighting_block>(this, 350));
			...
			Add(AmbienceSoundClusters = new TI.Block<structure_bsp_sound_cluster_block>(this, 512));
			Add(ReverbSoundClusters = new TI.Block<structure_bsp_sound_cluster_block>(this, 512));
			Add(TransparentPlanes = new TI.Block<transparent_planes_block>(this, 32768));
			Add(new TI.Pad(96));
			Add(VehicleSpericalLimitRadius = new TI.Real());
			Add(VehicleSpericalLimitCenter = new TI.RealPoint3D());
			Add(DebugInfo = new TI.Block<structure_bsp_debug_info_block>(this, 1));
			...
			Add(ObjectFakeLightprobes = new TI.Block<structure_bsp_fake_lightprobes_block>(this, 2048));
